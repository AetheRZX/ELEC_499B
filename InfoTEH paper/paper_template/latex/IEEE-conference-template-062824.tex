...
as illustrated in \Cref{fig:hall_sensor_comparison}. %%% FIX THIS, NEED NEW IMAGE
% \begin{figure}[htbp]
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\columnwidth]{figures/MTPA_flowdiagram.png}
...
The system dynamically adjusts both corrections in real time to maintain optimal performance under transients.
