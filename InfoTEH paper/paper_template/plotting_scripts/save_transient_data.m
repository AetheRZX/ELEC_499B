...
if isempty(i_ds_avg) && ~isempty(yout_ds)
    i_ds_avg = get_sig_safe(yout_ds, 'i_ds_avs');
end

% --- DEBUG SECTION ---
if isempty(i_ds) || isempty(i_ds_avg)
    fprintf('\n!!! SIGNALS MISSING !!!\n');
    fprintf('They were not found in "logsout".\n');
    fprintf('Please go to Simulink, RIGHT CLICK the "i_ds" and "i_ds_avs" lines, and select "Log Selected Signals".\n');
